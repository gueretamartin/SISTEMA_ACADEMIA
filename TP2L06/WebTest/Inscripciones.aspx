<%@ Page Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="Inscripciones.aspx.cs" Inherits="WebTest.Inscripciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" runat="server">
    ...
    <asp:Panel ID="formPanel" Visible="false" runat="server">
        <div class="form-group">
            ...
            <asp:Label Text="Fecha de Nacimiento (DD/MM/AAAA): " ID="lblFecha" runat="server" />
